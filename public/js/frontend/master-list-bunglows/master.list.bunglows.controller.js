(function() {
  ...
  BunglowListView = (function(superClass) {
    ...
    BunglowListView.prototype.template = Handlebars.compile('	<div class=" info"> <label class="pull-left">{{unit_name}}</label><span class="status-icon"></span> <div class="pull-right">{{unit_type}}</div> <!--{{super_built_up_area}}sqft--> <div class="clearfix"></div> </div> <div class="cost"> <span class="icon-rupee-icn"> {{price}}</span> </div>');
