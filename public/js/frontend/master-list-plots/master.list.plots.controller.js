(function() {
  ...
  PlotListView = (function(superClass) {
    ...
    PlotListView.prototype.template = Handlebars.compile('	<div class="info"> <h2 class="m-b-5">{{unit_name}}</h2> <div class="floors"><span>{{unit_type}}</span></div> </div> <div class="clearfix"></div> <div class="unit-type-info"> <div class="price {{classname}}"> <span class="icon-rupee-icn">{{price}}</span></div> </div>');
