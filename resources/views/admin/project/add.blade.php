                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="select_area_list" id="autocompleteArea" placeholder="Locality Name" disabled/>
...
<!--                                     <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select data-parsley-required name="cf_project_id" class="select2 form-control" disabled>
