                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" required name="no_of_flats" 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="unit_type_id" class="floor-layout-unit-types full-width" onchange="getVariants(this,{{ $floorLayout->id }});">
