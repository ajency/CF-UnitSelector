    ...
    <div class="col-md-12">
        <div class="grid simple">
            <div class="grid-title">
                ...
                <a class="btn btn-primary pull-right" href="{{ url('/admin/project/'. $project['id'] .'/plot-unit/create') }}" >+ Add Unit</a>
            </div>
            <div class="grid-body">
                <table class="table table-striped" id="example2" >
                    ...
                    <tbody> 
                        @foreach ($unit_arr as $unit)
                            <tr class="">
                                <td><a href="{{ url( '/admin/project/' . $project['id'] . '/plot-unit/'.$unit['id'].'/edit') }}">{{ $unit['unit_name'] }}</a></td>
