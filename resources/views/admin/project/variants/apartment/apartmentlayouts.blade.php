            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div id="2dlayout_0">
                        ...
                        <button onclick="deleteLayout({{ $layouts[0]['2d']['ID'] }}, '2d');" type="button" class="btn btn-small btn-default m-t-10 pull-right"><i class="fa fa-trash"></i> Delete</button>
                        @else
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div id="3dlayout_0">
                        ...
                        <button onclick="deleteLayout({{ $layouts[0]['3d']['ID'] }}, '3d');" type="button" class="btn btn-small btn-default m-t-10 pull-right"><i class="fa fa-trash"></i> Delete</button>
                        @else
