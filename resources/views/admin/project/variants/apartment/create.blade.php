            ...
            <div id="addFloorlevel"> 
                ...
                <div class="row" id="level_0">
                    <div class="m-l-5 no-border">
                        <button type="button" class="btn btn-small btn-default pull-right m-r-25 add_level hidden" ><i class="fa fa-plus"></i> Add New Level</button>
                ...
                <div class="row hidden" id="level_1">
                    <div class="no-border">
