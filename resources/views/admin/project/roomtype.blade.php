        ...
        <div class="b-grey b-t b-b b-l b-r p-t-10 p-r-15 p-l-15 p-b-15 m-b-10 text-grey">
            ...
            <div class="row">
                ...
                <div class="col-md-5" id="controltype_values_{{$roomtypeId}}">
                    <div class="form-inline">
                        <div class="form-group">
                            <input type="controltypevalues_{{$roomtypeId}}" class="form-control" value="{{$attributes['defaults']}}">
            ...
            <div class="row">
                ...
                <div class="col-md-5" id="controltype_values_{{$roomtypeId}}">
                    <div class="form-inline">
                        <div class="form-group">
                            <input type="controltypevalues_{{$roomtypeId}}" class="form-control" placeholder="">
                            <!--<button class="btn btn-small btn-default m-t-5"><i class="fa fa-trash"></i> Delete</button>-->
                        </div>
                    </div>
                </div>
        ...
        <div class="b-grey b-t b-b b-l b-r p-t-10 p-r-15 p-l-15 p-b-15 m-b-10 text-grey">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="">
                            <input type="text" name="attribute_name_projattr" class="form-control" value="{{$attributes['label']}}" placeholder="Attribute Name">
                            <input type="hidden" name="attribute_id_projattr" value="{{$attributes['id']}}">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-inline">
                        <div class="form-group">
                            <select name="controltype_projattr">
                                <option value="">Controls</option>
                                <option value="textbox" @if($attributes['control_type']=='textbox'){{'selected'}}@endif> Text Box</option>
                                <option value="textarea" @if($attributes['control_type']=='textarea'){{'selected'}}@endif> Textarea </option>
                                <option value="select" @if($attributes['control_type']=='select'){{'selected'}}@endif>Select Box</option>
                ...
                <div class="col-md-5" id="controltype_values_projattr">
                    <div class="form-inline">
                        <div class="form-group">
                            <input type="controltypevalues_projattr" class="form-control" value="{{$attributes['defaults']}}">
                            <!--<button class="btn btn-small btn-default m-t-5"><i class="fa fa-trash"></i> Delete</button>-->
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        <div class="">
                            <input type="text" name="attribute_name_projattr" class="form-control" placeholder="Attribute Name">
                            <input type="hidden" name="attribute_id_projattr" value="">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-inline">
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-white" onclick="addRoomtypeAttributes('projattr',this)"><i class="fa fa-plus"></i></button>
                        </div>
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="form-inline">
                        <div class="form-group">
                            <input type="controltypevalues_projattr" class="form-control" placeholder="">
                            <!--<button class="btn btn-small btn-default m-t-5"><i class="fa fa-trash"></i> Delete</button>-->
                        </div>
                    </div>
                </div>
            </div>
            <div class="row"  id="addroomtypeattributeblock_projattr">
                <div class="col-md-12">

                    <div class="text-right"> 
                        <button type="button" class="btn btn-small btn-primary" onclick="saveRoomypeattribute({{$project['id']}},'projattr','property');"><i class="fa fa-save"></i> Save</button>
                        <button type="button" class="btn btn-small btn-default"><i class="fa fa-trash"></i> Delete</button>
                    </div>
