                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div>
                                    ...
                                    <input type="number" class="form-control m-b-5" name="villa_attributes[{{ $attributes['label'] }}]" value="{{ $value }}" placeholder="Enter {{ $attributes['label'] }}" data-parsley-required data-parsley-type="number">
