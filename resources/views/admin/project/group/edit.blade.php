                ...
                <div class="grid-body grid-padding no-border">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                       ...
                                       <input required="" type="text" class="form-control" name="group_name"  value="{{ $building->building_name }}"  placeholder="Enter Building Name" data-parsley-required onchange="validateBuildingName(this,{{ $building->id }});" {{ $disabled }}><div class="cf-loader hidden"></div>
                                        </div>
                  ...
                  <div class="dataTables_wrapper form-inline" role="grid">
                    ...
                    <table class="table table-striped dataTable">
                        ...
                        <tbody id="master-img">
                            @if(!empty($svgImages))
                            <?php
                                $breakpoints = (!empty($group->breakpoints)) ? unserialize($group->breakpoints) : [];
                                ?>
