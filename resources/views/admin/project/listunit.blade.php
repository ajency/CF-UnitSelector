  ...
  <form action="{{ url( 'admin/project/' . $project['id'].'/bunglow-unit/unitimport') }}"  method="POST" enctype="multipart/form-data" data-parsley-validate>          
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <a href="{{ url( 'admin/project/' . $project['id'].'/unitexport/'.BUNGLOWID ) }}" target="_blank" class="pull-right btn btn-default btn-small m-l-5"><i class="fa fa-download"></i> Download config</a>
