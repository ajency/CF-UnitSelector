                                ...
                                <div class="panel panel-default vertical orange">
                                    ...
                                    <h4 class="panel-title">
                                        ...
                                        <input type="hidden" value="1" name="levels[]">
                                            ...
                                            <button title="Delete Level"  type="button" class="btn btn-white btn-small dellevel pull-right" onclick="deleteLevel(1);" id="deletelevel_1" style="position: absolute;right: 22px;top: -4px;">
