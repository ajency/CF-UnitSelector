...
<div class="page-title">	
    <h2><span class="semi-bold">View</span> Agents</h2>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="grid simple">
            <div class="grid-title">
                <h4>List of <span class="semi-bold">Agents</span></h4>
                <a class="btn btn-primary pull-right" href="{{ url('/admin/agent/create') }}" ><i class="fa fa-plus"></i> Add Agent</a>
            </div>
            <div class="grid-body">
                <table class="table table-bordered userList" id="example2" >
                    ...
                    <tbody> 
                        @foreach ($users as $user)
                            <tr class="" onclick="location.href='{{ url( '/admin/agent/' . $user['id'] . '/edit') }}'">
                                <td>{{ $user['name'] }}</td>
                                <td>{{ $user['email'] }}</td>
                                <td>{{ $user['phone'] }}</td>
