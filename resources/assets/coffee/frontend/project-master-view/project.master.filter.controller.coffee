	...
	template : Handlebars.compile('{{#villaFilters}}
									<div class="filters-wrapper">
										<div class="filter-chkbox-block">
											<input type="checkbox" name="villa" class="custom-chckbx"  checked  />
										...
										<div class="filter-chkbox-block">
											...
											<input type="checkbox" class="villaFilters unit_types custom-chckbx" name="{{id}}" id="{{id}}" value="1" checked />
										...
										<div class="filter-chkbox-block">
											...
											<input type="checkbox" class="villaFilters unitvariants custom-chckbx" name="{{id}}" id="{{id}}" value="1" checked />
											<label for="{{id}}">{{area}} Sq.Ft</label>
										...
										<div class="filter-chkbox-block">
											...
											<input type="checkbox" class="villaFilters status custom-chckbx" name="{{name}}" id="{{name}}" value="1" checked />
