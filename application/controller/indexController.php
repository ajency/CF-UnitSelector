<?php
  ...
  function formatAmount($n) {
        ...
        // now filter it;
        if($n>1000000000000) return round(($n/1000000000000),1).' Cr';
        else if($n>1000000000) return round(($n/1000000000),1).' Cr';
        else if($n>1000000) return round(($n/1000000),1).' Lacs';
...
function saveBuyerInfo($buyer_id,$buyerData ,$billingData){
    ...
    function invoiceHtml($bookingId)
    {
      ...
      $html ='<!DOCTYPE html>
              ...
              <!-- BODY -->
              <table cellpadding="15" cellspacing="0" width="630" style="margin:0 auto;">
                <tr>
                  <td>
