...
define('unitSummary','http://unitselector.com/api/v2/unit/');
define('getUnitStatus','http://unitselector.com/api/v2/get-unit-status?unit_id=');
define('updateUnitStatus','http://unitselector.com/api/v2/unit/');
