...
class Permission {
	...
	public function handle($request, Closure $next)
	{
        $resources =['admin.project.index'=>['read_project'],
                     ...
                     'admin.project.leads.index'=>['read_project','configure_project'],
        ...
        $uri        =['admin/project/{project}/cost'=>['configure_project'],
                      ...
                      'admin/project/{id}/master/authoring-tool'=>['svg_auth_tool'],
                      'admin/project/{project}/svg-tool'=>['svg_auth_tool'],
                      'admin/project/{project}/svg-tool/{svg_tool}'=>['svg_auth_tool'],
                      'admin/project/{projectid}/image/{imageid}'=>['svg_auth_tool'],
                      'admin/project/{id}/image/{imageid}/authoring-tool'=>['svg_auth_tool'],
                      'admin/project/{projectid}/image/{imageid}/duplicate_image_id/{image_id}'=>['svg_auth_tool'],
                      'admin/project/{projectid}/image/{imageid}/downloadSvg'=>['svg_auth_tool'],
